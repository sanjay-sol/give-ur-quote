      ...
      <section className="w-full px-8 lg:mt-10 md:mt-10 py-16 bg-black xl:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="w-full space-y-5 md:w-3/5 md:pr-16">
              ...
              "Anonymity is not a crime, it is a choice." - Unknown
              </p>
            </div>
            ...
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
              ...
              >
                ...
                <div className="block">
                  <button
                    className="w-full px-3 py-4 text-black font-bold bg-yellow-600 hover:bg-yellow-500 rounded-lg"
